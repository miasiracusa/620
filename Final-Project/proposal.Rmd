...
The data will be obtained from a subset of Kaggle's 2013 [Yelp Review Challenge](https://www.kaggle.com/c/yelp-recsys-2013/data) to include only businesses within the food and beverage industries that operate in the Phoenix, Arizona metropolitan area. Inspiration for this project comes from a concurrent assignment for [Data 612](http://rpubs.com/jemceach/D212-Final-Project), in which the data is being used to build a recommender system. 
...
7.  Sentiment Analysis: Juliann
8.  Conclusion: Juliann
