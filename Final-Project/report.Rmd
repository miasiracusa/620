...
```{r}
#prepare data
business <- unique(relationship$business_name)
business <- as.character(relationship$business_name)
user <- as.character(relationship$user_name)

#create dataframe
df <- cbind(business, user)
...
#Make businesses pink squares and make users blue circles 
